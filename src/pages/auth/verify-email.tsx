        ...
        <div className="flex justify-center gap-3">
          {code.map((digit, i) => (
            <input
              ...
              className="h-14 w-12 rounded-lg border border-border bg-input text-center text-xl font-bold text-foreground transition-colors focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring"
            />
          ))}
        </div>
